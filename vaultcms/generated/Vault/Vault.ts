...
export class Vault__fetchPostResultValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
...
export class Vault__fetchPostsResultValue0Struct extends ethereum.Tuple {
  get id(): BigInt {
    return this[0].toBigInt();
  }
...
export class Vault extends ethereum.SmartContract {
  ...
  fetchPost(hash: string): Vault__fetchPostResultValue0Struct {
    ...
    return changetype<Vault__fetchPostResultValue0Struct>(result[0].toTuple());
  }

  try_fetchPost(
    hash: string
  ): ethereum.CallResult<Vault__fetchPostResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Vault__fetchPostResultValue0Struct>(value[0].toTuple())
    );
  }

  fetchPosts(): Array<Vault__fetchPostsResultValue0Struct> {
    let result = super.call(
      "fetchPosts",
    ...
    return result[0].toTupleArray<Vault__fetchPostsResultValue0Struct>();
  }

  try_fetchPosts(): ethereum.CallResult<
    Array<Vault__fetchPostsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchPosts",
      "fetchPosts():((uint256,string,string,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Vault__fetchPostsResultValue0Struct>()
    );
  }
